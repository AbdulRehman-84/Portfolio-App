    ...
    return Column(
      ...
      children: [
        ...
        FadeInDown(
          ...
          child: Expanded(
            child: Text(
              '👨‍💻 Flutter Developer | Crafting beautiful & responsive apps 🚀'
              '📱 Expertise in UI/UX, state management, and Firebase integration 🔥'
              '🌍 Open to collaboration & exciting Flutter projects! ✨',
